...
REPLACE INTO `goods` (`g_id`, `g_name`, `stock`, `sale`, `price`, `score`, `rater_num`) VALUES
	('C01', '大葱', 4, 50, 20, 3.2, 3),
	('C02', '白菜', 20, 30, 10, 4.7, 102),
	('C03', '土豆', 21, 23, 43, 4.9, 122),
	('C04', '羊', 101, 2434, 32, 4.6, 211),
	('P01', '白鸡', 50, 0, 10, 3.16667, 3),
	('P02', '鸭子', 20, 0, 6, 0, 0),
	('P03', '牛肉', 30, 0, 40, 0, 0),
	('P04', '羊', 10, 0, 40, 0, 0),
	('P05', '鱼', 50, 0, 10, 0, 0);
...
REPLACE INTO `order` (`o_id`, `customer_id`, `g_id`, `amount`, `score`) VALUES
	('O01', 'U3365824', 'C03', 22, 5),
	('O02', 'U3875211', 'C01', 23, 4),
	('O03', 'U3875211', 'C03', 212, 4),
	('O04', 'U3559363', 'P03', 2, 4),
	('O05', 'U3949267', 'C03', 34, 5),
	('O06', 'U3365824', 'P02', 43, 3),
	('O07', 'U3295433', 'P01', 44, 3),
	('O08', 'U3493396', 'P04', 20, 1);
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `pwd` char(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '123456' COMMENT '密码',
...
REPLACE INTO `user` (`u_id`, `pwd`, `id_type`, `name`, `gender`, `age`, `tel`) VALUES
	('U0128311', 'pwd768', 0, '危素珊', 1, 28, '16800471240'),
	('U0435012', 'pwd017', 0, '史众旭', 1, 30, '18742660408'),
	('U0659050', 'pwd608', 0, '端木顺福', 0, 56, '13781814420'),
	('U0688739', 'pwd088', 0, '甄淳', 1, 20, '15216166514'),
	('U1089205', 'pwd829', 1, '刀枝', 0, 27, '19764282389'),
	('U1256977', 'pwd675', 1, '童洪彬', 0, 40, '18007012712'),
	('U1577235', 'pwd565', 1, '佘蕊晓', 1, 25, '13493346347'),
	('U2270119', 'pwd994', 2, '邰元', 1, 38, '14712268387'),
	('U2379633', 'pwd167', 2, '夏侯贞', 0, 19, '16133166846'),
	('U2787669', 'pwd144', 2, '孟剑', 1, 30, '17311655583'),
	('U2988270', 'pwd437', 2, '赫嘉', 0, 38, '14728770657'),
	('U3219216', 'pwd549', 3, '池佳一', 1, 64, '14799966768'),
	('U3295433', 'pwd757', 2, '那洪东', 0, 28, '15428784294'),
	('U3365824', 'pwd651', 3, '庄雪子', 1, 54, '18014284486'),
	('U3493396', 'pwd784', 3, '平睿宙', 0, 55, '16841732033'),
	('U3545579', 'pwd218', 3, '区璧', 0, 48, '14743240290'),
	('U3559363', 'pwd089', 3, '封荔锦', 1, 29, '13200463406'),
	('U3717569', 'pwd076', 3, '陈琰', 1, 54, '19871221799'),
	('U3871667', 'pwd482', 3, '尹丞安', 1, 30, '18474659228'),
	('U3875211', 'pwd988', 3, '崔家昊', 0, 30, '15560245831'),
	('U3946853', 'pwd493', 3, '仝和', 1, 38, '17233763386'),
	('U3949267', 'pwd778', 3, '赫厚旻', 1, 54, '13633146035'),
	('U4655222', 'pwd749', 1, '葛懿', 0, 37, '19484283457'),
	('U4691729', 'pwd358', 1, '桂燕', 0, 44, '19840825329'),
	('U4924694', 'pwd599', 1, '徐廷新', 0, 30, '17583120162'),
	('U5278444', 'pwd408', 2, '卓君轩', 1, 38, '19565043473'),
	('U5430317', 'pwd415', 2, '狄薇泓', 0, 37, '18525156302'),
