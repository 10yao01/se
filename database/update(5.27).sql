...
-- 正在导出表  se.batch 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `batch` DISABLE KEYS */;
INSERT INTO `batch` (`b_id`, `b_date`, `p_id`, `g_id`, `amount`) VALUES
...
INSERT INTO `farm` (`f_id`, `f_name`, `c_id`, `c_name`, `c_amount`, `p_date`, `w_id`, `harvest_date`, `stage`, `pos_info`) VALUES
...
-- 正在导出表  se.fertile 的数据：~0 rows (大约)
/*!40000 ALTER TABLE `fertile` DISABLE KEYS */;
INSERT INTO `fertile` (`f_id`, `farm_id`, `irrigate_time`, `fertile_time`) VALUES
	('F01', 'F02', '2024-05-25', '2024-05-25');
/*!40000 ALTER TABLE `fertile` ENABLE KEYS */;
...
INSERT INTO `goods` (`g_id`, `stock`, `sale`, `price`, `score`, `raters_num`) VALUES
...
INSERT INTO `order` (`o_id`, `customer_id`, `g_id`, `amount`, `score`) VALUES
...
INSERT INTO `pasture` (`p_id`, `p_name`, `poultry_id`, `poultry_name`, `poulty_num`, `start_time`, `w_id`, `mature_time`, `stage`, `pos_info`) VALUES
	('P01', '养鸡场', 'P01', '鸡', 16, '2024-05-25', 'U5504479', '2024-06-02', 1, '山西省朔州市应县'),
	('P02', '养鸭场', 'P02', '鸭', 32, '2024-05-25', 'U8430317', '2024-05-30', 1, '四川省黎川县'),
	('P03', '渔场', 'P05', '鲤鱼', 25, '2024-05-25', 'U6574819', '2024-05-27', 1, '四川省泸州市叙永县'),
	('P04', '养牛场', 'P03', '奶牛', 12, '2024-05-25', 'U5270119', '2024-05-31', 1, '湖南省株洲市芦淞区里'),
	('P05', '羊场', 'P04', '绵羊', 14, '2024-05-25', 'U5379633', '2024-05-26', 1, '河南省郑州市惠济区园河东路');
...
/*!40000 ALTER TABLE `poultry` DISABLE KEYS */;
INSERT INTO `poultry` (`p_id`, `p_name`, `p_info`, `feed_interval`) VALUES
	...
	('P04', '羊', '咩', 3),
	('P05', '鱼', 'a', 3);
/*!40000 ALTER TABLE `poultry` ENABLE KEYS */;
