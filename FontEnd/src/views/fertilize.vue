    ...
    <el-main>
      <el-row :gutter="20">
        <el-col :span="22" :offset="1">
          <el-input style="width: 20%;" placeholder="请输入施肥编号" v-model="searchFid" />
          <el-input style="width: 20%;" placeholder="请输入农田编号" v-model="searchFarmid" />
          <el-input style="width: 20%;" placeholder="请输入施肥时间" v-model="searchTime" />
      ...
      <el-row >
        <el-col :span="22" :offset="1">
          <el-table :data="pagedData" border height="550" style="width: 100%">
            <el-table-column prop="fid" label="施肥编号" sortable>
            </el-table-column>
            <el-table-column prop="farmid" label="农田编号" sortable>
            </el-table-column>
          <el-table-column prop="optime" label="施肥时间">
          </el-table-column>
          <el-table-column label="操作">
            <template slot-scope="scope">
              ...
              <el-dialog title="修改施肥信息" :visible.sync="dialogFormVisible2" width="30%">
                <el-form :model="dialogForm2">
                  <el-form-item label="施肥编号" :label-width="formLabelWidth">
