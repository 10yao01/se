    ...
    <el-main>
      <el-row :gutter="20">
        <el-col :span="22" :offset="1">
          <el-input style="width: 20%;" placeholder="请输入商品编号" v-model="searchName" />
          <el-input style="width: 20%;" placeholder="请输入商品名称" v-model="searchName" />
      ...
      <el-row >
        <el-col :span="22" :offset="1">
          ...
          <el-table-column prop="fid" label="商品编号" sortable>
          </el-table-column>
          <el-table-column prop="image" label="商品名称">
            </el-table-column>
          <el-table-column prop="image" label="余量">
            </el-table-column>
          <el-table-column prop="image" label="销量">
            </el-table-column>
          <el-table-column prop="image" label="价格">
            </el-table-column>
          <el-table-column prop="image" label="平均评分">
